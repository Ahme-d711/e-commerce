...
export default function Navbar() {
  ...
  return(
    <div className="flex gap-6 justify-between items-center shadow-[0_.1px_4px] shadow-blackA4 p-4">
      <Link to="/" className="flex">
        ...
        <h1 className=" text-gray-500 md:text-2xl flex gap-1">Elgedawy <span className="md:text-3xl text-rose-500">Market</span></h1>
      </Link>
      {user ? (
        <>
          <NavigationMenuDemo />
          <div className="flex gap-3 items-center lg:min-w-72 justify-end">
            <div className="relative">
              <Link to="/cart">
                <ShoppingCart className="text-gray-300 size-5 md:size-8 cursor-pointer animate-bounce"/>
              </Link>
